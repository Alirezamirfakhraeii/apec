...
@php
    ...
    $selectedType = old('type', $selectedType ?? 'news');
@endphp
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('title') }}"
                                   placeholder="عنوان جذاب و سئو شده بنویسید..."
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="summary"
                                      ...
                                      placeholder="خلاصه‌ای کوتاه برای بخش کارت‌ها...">{{ old('summary') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body"
                                      id="editor"
                                      class="form-control js-ckeditor @error('body') is-invalid @enderror">{{ old('body') }}</textarea>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea name="meta_description"
                                      ...
                                      placeholder="توضیحات جذاب برای گوگل...">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="card-body">
                            ...
                            <select name="blog_category_id"
                                ...
                                @foreach($categories->where('parent_id', null) as $mainCat)
                                    <option value="{{ $mainCat->id }}"
                                        ...
                                        {{ old('blog_category_id') == $mainCat->id ? 'selected' : '' }}>
                                        📁 {{ $mainCat->name }}
                                    </option>
                                    ...
                                    @foreach($mainCat->children as $child)
                                        <option value="{{ $child->id }}"
                                                class="text-primary"
                                            {{ old('blog_category_id') == $child->id ? 'selected' : '' }}>
                                            &nbsp;&nbsp;&nbsp;&nbsp; └─ 📄 {{ $child->name }}
                                        </option>
                                    @endforeach
                                @endforeach
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('tags') }}"
                                   placeholder="مثال: انرژی, نفت_خام, توسعه">
