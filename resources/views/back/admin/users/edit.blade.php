...
@section('content')
    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-7 col-lg-7 col-md-12">
            <div class="card box-shadow-0">
                <div class="card-header border-bottom">
                    <h4 class="card-title mb-1 text-primary"><i class="fa fa-user-edit ml-2"></i>اصلاح مشخصات کاربری</h4>
                    ...
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="اگر مایل به تغییر نیست، خالی بگذارید">
                                <small class="text-warning d-block mt-1"><i class="fa fa-info-circle ml-1"></i> در صورت ورود رمز جدید، نشست‌های فعال کاربر منقضی خواهد شد.</small>
        ...
        <div class="col-xl-5 col-lg-5 col-md-12">
            ...
            <div class="card bg-primary-transparent text-primary mb-3">
                <div class="card-body p-3 d-flex align-items-center">
                    <div class="main-img-user avatar-md ml-3">
                        <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center fw-bold" style="width: 50px; height: 50px; font-size: 20px;">
                            {{ mb_substr($user->name, 0, 1) }}
                        </div>
                    </div>
                    <div>
                        <h5 class="mb-1 font-weight-semibold text-dark">{{ $user->name }}</h5>
                        <p class="mb-0 font_12 text-muted">عضویت از: {{ $user->created_at ? $user->created_at->format('Y-m-d') : 'نامشخص' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title mb-1 text-dark"><i class="fa fa-chart-line ml-2"></i>خلاصه وضعیت و رفتار کاربر</h4>
                </div>
                <div class="card-body p-0">
                    <table class="table table-striped mb-0 font_13">
                        ...
                        <tr>
                            ...
                            <td class="text-left pl-3"><span class="badge badge-light border text-dark">#{{ $user->id }}</span></td>
                        </tr>
                        <tr>
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title mb-1 text-dark"><i class="fa fa-history ml-2"></i>توضیحات و راهنمای مدیریتی</h4>
                </div>
                <div class="card-body font_13 text-justify text-muted" style="line-height: 24px;">
                    <p><i class="fa fa-shield-alt text-warning ml-1"></i> <strong>تغییر سطوح دسترسی:</strong> با تخصیص نقش‌های سیستمی، این کاربر می‌تواند به منوها، گزارشات و ابزارهای حساس در بک‌اند دسترسی پیدا کند.</p>
                    <p class="mb-0"><i class="fa fa-exclamation-triangle text-danger ml-1"></i> <strong>امنیت حساب:</strong> به عنوان ادمین کل، در صورتی که گزارش مشکوکی از رفتار کاربر دریافت کردید، توصیه می‌شود ابتدا رمز عبور او را تغییر داده یا دسترسی نقشی او را روی حالت «کاربر عادی» بگذارید.</p>
                </div>
            </div>
        </div>
    </div>
