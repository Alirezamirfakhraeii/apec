...
@section('content')
    ...
    <div class="news-admin-wrapper project-form-wrapper">
        ...
        <div class="news-page-header mb-4 d-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                <div class="news-page-subtitle">
                    اطلاعات پروژه مربوط به یکی از شرکت‌های عضو را وارد کنید.
                </div>
            </div>
        ...
        <form action="{{ route('admin.company-projects.store') }}"
              method="POST">
                                ...
                                <select name="company_id"
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->id }}"
                                            {{ (string) old('company_id') === (string) $company->id
                                                ? 'selected'
                                                : ''
                                            }}>
                        ...
                        <div class="col-12">
                            ...
                            <div class="project-form-group mb-0">
                                ...
                                <textarea name="service_description"
                                          ...
                                          placeholder="خدمات انجام‌شده یا قابل ارائه در این پروژه را توضیح دهید...">{{ old('service_description') }}</textarea>
