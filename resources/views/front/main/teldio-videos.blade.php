                                ...
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }} h-100">
                                    <article class="notice-premium-slide">
                                        ...
                                        <div class="notice-premium-overlay">
                                            ...
                                            <a href="{{ route('front.posts.show', $post->slug) }}" class="notice-premium-slide-title">
                                                {{ $post->title }}
                                            </a>
...
<style>
    ...
    .notice-premium-list-item.active {
        background: linear-gradient(90deg, rgba(16, 185, 129, 0.13), #ffffff 72%);
        border-color: rgba(16, 185, 129, 0.35);
    ...
    .notice-premium-overlay {
        ...
        background:
            linear-gradient(180deg, rgba(15, 23, 42, 0.06) 0%, rgba(15, 23, 42, 0.38) 48%, rgba(15, 23, 42, 0.92) 100%);
    }
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var myNoticeCarousel = document.getElementById('announcementNewsCarousel');
        var noticeIndicators = document.querySelectorAll('.notice-premium-carousel .notice-premium-list-item');

        if (myNoticeCarousel) {
            myNoticeCarousel.addEventListener('slide.bs.carousel', function (e) {
                var nextIdx = e.to;
                ...
                noticeIndicators.forEach(function (btn, idx) {
                    if (idx === nextIdx) {
                        ...
                        var progressBar = btn.querySelector('.notice-premium-progress');
